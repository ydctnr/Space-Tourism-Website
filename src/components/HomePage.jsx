    ...
    >
      <div className='container'>
        ...
        <div className='grid grid-flow-row gap-10 md:grid-flow-col text-center lg:text-left'>
          ...
          <div className='animate-bounceSmall hover:font-semibold flex w-[10em] h-[10em] md:w-[12em] md:h-[12em] lg:w-[10em] lg:h-[10em] justify-center bg-white rounded-full cursor-pointer absolute m-auto left-0 right-0 bottom-0 md:bottom-20 lg:left-1/2 lg:bottom-16'
